...
- **Wechselseitiger Ausschluss**: Ist ein Thread in einem Monitor, so wird er gesperrt. Jede Thread, der jetzt eintreten will, landet auf einer Warteschlange.
...
* **Eingangswarteschlange**: Hier warten Threads, die den Monitor überhaupt erst betreten wollen.
* **Bedingungswarteschlange**: Hier warten Threads, die bereits im Monitor waren, aber schlafen gelegt wurden, weil eine Bedingung nicht erfüllt war.
